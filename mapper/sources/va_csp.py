...
class VaCspApiSource:
    def __init__(self, desc):
        if "subject" not in desc:
            raise RuntimeError("missing subject in VA CSP source")
...
def get_data(subject):
    ...
    jurisdiction_id = "27D1AF28D2F54DD3A69C057DDA772BD0"
    res = requests.get(
    ...
    data = []
    logging.info(f"Loading all Virginia {subject} standards")
