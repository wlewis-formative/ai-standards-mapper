...
class CspApiSource:
    def __init__(self, desc):
        ...
        self.data = download_csp_data(desc["jurisdiction"], desc["subject"])
...
def download_csp_data(jurisdiction, subject):
    """Download all CSP standards for the provided jurisdiction and subject."""
